...
//	self->monsterinfo.dodge = hover_dodge;
	...
	// 400 stat total
	self->pokemonStats.baseStats[0] = 50;
	self->pokemonStats.baseStats[1] = 30;
	self->pokemonStats.baseStats[2] = 65;
	self->pokemonStats.baseStats[3] = 80;
	self->pokemonStats.baseStats[4] = 65;
	self->pokemonStats.baseStats[5] = 110;
	...
	pokemonMove learnableMoves[] = { {.name = "Quick Attack",.moveType = 1,   .power = 40, .priority = 1, .accuracy = 1.0f, .type = NORMAL,  .levelRequirement = 1, .selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,0,0,0,0}, .statusEffectChance = 0.0f, .statusEffect = NONE,  .stateChangeChance = 0.0f},
									...
									{.name = "Hurricane", .moveType = 3,  .power = 110,  .priority = 0, .accuracy = .7f, .type = FLYING,    .levelRequirement = 25,	.selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,0,0,0,0}, .statusEffectChance = 0.0f, .statusEffect = NONE, .stateChangeChance = 0.0f} };

	int EVYield[] = { 0,0,0,2,0,0 };

	self->pokemonStats.evolveLevel = 36;
	self->pokemonStats.evolveTo = "monster_boss2";
