...
void SP_monster_flyer (edict_t *self)
{
	...
	// 300 stat total
	self->pokemonStats.baseStats[0] = 20;
	self->pokemonStats.baseStats[1] = 25;
	self->pokemonStats.baseStats[2] = 45;
	self->pokemonStats.baseStats[3] = 65;
	self->pokemonStats.baseStats[4] = 50;
	self->pokemonStats.baseStats[5] = 95;
	...
	pokemonMove learnableMoves[] = { {.name = "Quick Attack",.moveType = 1,   .power = 40, .priority = 1, .accuracy = 1.0f, .type = NORMAL,  .levelRequirement = 1, .selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,0,0,0,0}, .statusEffectChance = 0.0f, .statusEffect = NONE,  .stateChangeChance = 0.0f},
									{.name = "Gust",		.moveType = 3,   .power = 40, .priority = 0, .accuracy = 1.0f, .type = FLYING,    .levelRequirement = 3, .selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,0,0,0,0}, .statusEffectChance = .1f, .statusEffect = BURNED,.stateChangeChance = 0.0f},
	...
	int EVYield[] = { 0,0,0,1,0,0 };

	self->pokemonStats.evolveLevel = 16;
	self->pokemonStats.evolveTo = "monster_hover";
