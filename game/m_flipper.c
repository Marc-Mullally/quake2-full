...
void SP_monster_flipper (edict_t *self)
{
	...
	self->pokemonStats.level = 25 + (rand() % 5);
	self->pokemonStats.type[0] = WATER;
	self->pokemonStats.type[1] = GROUND;

	// 500 stat total
	self->pokemonStats.baseStats[0] = 65;
	self->pokemonStats.baseStats[1] = 120;
	self->pokemonStats.baseStats[2] = 70;
	self->pokemonStats.baseStats[3] = 50;
	self->pokemonStats.baseStats[4] = 75;
	self->pokemonStats.baseStats[5] = 120;
	...
	pokemonMove learnableMoves[] = { {.name = "Quick Attack",.moveType = 1,   .power = 40, .priority = 1, .accuracy = 1.0f, .type = NORMAL,  .levelRequirement = 1, .selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,0,0,0,0}, .statusEffectChance = 0.0f, .statusEffect = NONE,  .stateChangeChance = 0.0f},
									{.name = "Bulldoze",		.moveType = 1,   .power = 60,  .priority = 0, .accuracy = 1.0f, .type = GROUND,  .levelRequirement = 5, .selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,0,-1,0,0},.statusEffectChance = 0.0f, .statusEffect = NONE,  .stateChangeChance = 1.0f},
									{.name = "Agility",		.moveType = -1,   .power = 0,  .priority = 0, .accuracy = -1.0f, .type = PSYCHIC, .levelRequirement = 10, .selfStateChange = {0,0,0,0,0,2,0,0},  .enemyStateChange = {0,0,0,0,0,0,0,0}, .statusEffectChance = 0.0f, .statusEffect = NONE,  .stateChangeChance = 1.0f},
									{.name = "Withdraw",		.moveType = -1,   .power = 0, .priority = 0, .accuracy = -1.0f, .type = WATER,    .levelRequirement = 15, .selfStateChange = {0,0,1,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,0,0,0,0}, .statusEffectChance = 0.0f, .statusEffect = NONE, .stateChangeChance = 1.0f},
									{.name = "Waterfall",	.moveType = -1,  .power = 80,  .priority = 0, .accuracy = 1.0f, .type = WATER,    .levelRequirement = 20,.selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,0,0,0,0}, .statusEffectChance = 0.0f, .statusEffect = NONE,.stateChangeChance = 0.0f},
									{.name = "Aqua Jet",	.moveType = 1,   .power = 40, .priority = 1, .accuracy = 1.0f, .type = WATER,  .levelRequirement = 30, .selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,0,0,0,0}, .statusEffectChance = 0.0f, .statusEffect = NONE,  .stateChangeChance = 0.0f},
									{.name = "Liquidation",		.moveType = 1,   .power = 85,  .priority = 0, .accuracy = 1.0f, .type = WATER,  .levelRequirement = 35, .selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,-1,0,0,0,0,0},.statusEffectChance = 0.0f, .statusEffect = NONE,  .stateChangeChance = 0.2f},
									{.name = "Earthquake",		.moveType = 1,   .power = 100,  .priority = 0, .accuracy = 1.0f, .type = GROUND, .levelRequirement = 40, .selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,0,0,0,0}, .statusEffectChance = 0.0f, .statusEffect = NONE,  .stateChangeChance = 0.0f},
									{.name = "Drill Run",		.moveType = 1,   .power = 80, .priority = 0, .accuracy = .95f, .type = GROUND,    .levelRequirement = 45, .selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,0,0,0,0}, .statusEffectChance = 0.0f, .statusEffect = NONE,.stateChangeChance = 0.0f},
									{.name = "Fishious Rend", .moveType = 1,  .power = 85,  .priority = 0, .accuracy = 1.0f, .type = WATER,    .levelRequirement = 50, .selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,0,0,0,0}, .statusEffectChance = 0.0f, .statusEffect = NONE, .stateChangeChance = 0.0f} };

	int EVYield[] = { 0,3,0,0,0,0 };
