...
void SP_monster_mutant (edict_t *self)
{
	...
	self->pokemonStats.type[0] = BUG;
	self->pokemonStats.type[1] = DARK;

	// 500 stat total
	self->pokemonStats.baseStats[0] = 60;
	self->pokemonStats.baseStats[1] = 80;
	self->pokemonStats.baseStats[2] = 55;
	self->pokemonStats.baseStats[3] = 90;
	self->pokemonStats.baseStats[4] = 45;
	self->pokemonStats.baseStats[5] = 70;

	pokemonMove learnableMoves[] = { {.name = "Bug Bite",	.moveType = 1,   .power = 60, .priority = 0, .accuracy = 1.0f, .type = BUG,  .levelRequirement = 1, .selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,0,0,0,0}, .statusEffectChance = 0.0f, .statusEffect = NONE,  .stateChangeChance = 0.0f},
									{.name = "String Shot",	.moveType = -1,   .power = 0,  .priority = 0, .accuracy = 0.95f, .type = BUG,  .levelRequirement = 3, .selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,0,-1,0,0},.statusEffectChance = 0.0f, .statusEffect = NONE,  .stateChangeChance = 1.0f},
									{.name = "Struggle Bug",.moveType = 3,   .power = 50,  .priority = 0, .accuracy = 1.0f, .type = BUG, .levelRequirement = 5, .selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,-1,0,0,0,0}, .statusEffectChance = 0.0f, .statusEffect = NONE,  .stateChangeChance = 1.0f},
									{.name = "Attack Order",.moveType = 1, .power = 90, .priority = 0, .accuracy = 1.0f, .type = BUG,  .levelRequirement = 7, .selfStateChange = {0,0,0,0,0,0,0,0},		 .enemyStateChange = {0,0,0,0,0,0,0,0}, .statusEffectChance = 0.0f, .statusEffect = NONE,  .stateChangeChance = 0.0f},
									{.name = "Defend Order", .moveType = -1,  .power = 0,  .priority = 0, .accuracy = -1.0f, .type = BUG,   .levelRequirement = 9,.selfStateChange = {0,0,0,1,1,0,0,0},  .enemyStateChange = {0,0,0,0,0,0,0,0}, .statusEffectChance = 0.0f, .statusEffect = NONE,.stateChangeChance = 1.0f},

									{.name = "Quiver Dance", .moveType = -1,  .power = 0,  .priority = 0, .accuracy = -1.0f, .type = BUG,    .levelRequirement = 17,.selfStateChange = {0,0,0,1,1,1,0,0},  .enemyStateChange = {0,0,0,0,0,0,0,0}, .statusEffectChance = 0.0f, .statusEffect = NONE,.stateChangeChance = 1.0f},
									{.name = "String Shot",	.moveType = -1,   .power = 0,  .priority = 0, .accuracy = 0.95f, .type = BUG,  .levelRequirement = 19, .selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,0,-1,0,0},.statusEffectChance = 0.0f, .statusEffect = NONE,  .stateChangeChance = 1.0f},
									{.name = "Bug Buzz",	.moveType = 3,   .power = 90,  .priority = 0, .accuracy = 1.0f, .type = BUG, .levelRequirement = 21, .selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,-1,0,0,0}, .statusEffectChance = 0.0f, .statusEffect = NONE,  .stateChangeChance = 0.1f},
									{.name = "Bite",		.moveType = 1, .power = 60, .priority = 0, .accuracy = 1.0f, .type = DARK,  .levelRequirement = 23, .selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,0,0,0,0}, .statusEffectChance = 0.0f, .statusEffect = NONE,  .stateChangeChance = 0.0f},
									{.name = "Lunge",		.moveType = 1,  .power = 80,  .priority = 0, .accuracy = 1.0f, .type = BUG,   .levelRequirement = 25,.selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,-1,0,0,0,0,0,0}, .statusEffectChance = 0.0f, .statusEffect = NONE,.stateChangeChance = 1.0f},
	
									{.name = "Nasty Plot",		.moveType = -1,  .power = 0,  .priority = 0, .accuracy = -1.0f, .type = DARK,   .levelRequirement = 37,.selfStateChange = {0,0,0,2,0,0,0,0},  .enemyStateChange = {0,0,0,0,0,0,0,0}, .statusEffectChance = 0.0f, .statusEffect = NONE,.stateChangeChance = 1.0f}, 
									{.name = "Crunch",			.moveType = 1,  .power = 80,  .priority = 0, .accuracy = 1.0f, .type = DARK,   .levelRequirement = 39,.selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,-1,0,0,0}, .statusEffectChance = 0.0f, .statusEffect = NONE,.stateChangeChance = 0.2f},
									{.name = "Night Daze",		.moveType = 3,  .power = 85,  .priority = 0, .accuracy = 0.95f, .type = DARK,   .levelRequirement = 41,.selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,0,0,-1,0}, .statusEffectChance = 0.0f, .statusEffect = NONE,.stateChangeChance = 0.4f},
									{.name = "Screech",			.moveType = -1,  .power = 0,  .priority = 0, .accuracy = .85f, .type = NORMAL,   .levelRequirement = 43,.selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,-2,0,0,0,0,0}, .statusEffectChance = 0.0f, .statusEffect = NONE,.stateChangeChance = 1.0f},
									{.name = "Skiter Smack",	.moveType = 1,  .power = 70,  .priority = 0, .accuracy = .9f, .type = BUG,   .levelRequirement = 45,.selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,-1,0,0,0,0}, .statusEffectChance = 0.0f, .statusEffect = NONE,.stateChangeChance = 1.0f} };

	int EVYield[] = { 3,0,0,0,0,0 };
