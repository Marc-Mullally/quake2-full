...
void SP_monster_berserk (edict_t *self)
{
	...
	self->pokemonStats.level = 16 + (rand() % 6);
	...
	pokemonMove learnableMoves[] = { {.name = "Quick Attack",.moveType = 1,   .power = 40, .priority = 1, .accuracy = 1.0f, .type = NORMAL,  .levelRequirement = 1, .selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,0,0,0,0}, .statusEffectChance = 0.0f, .statusEffect = NONE,  .stateChangeChance = 0.0f},
									...
									{.name = "Slash",		.moveType = 1,   .power = 70,  .priority = 0, .accuracy = 1.0f, .type = NORMAL,  .levelRequirement = 19, .selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,0,0,0,0},.statusEffectChance = 0.0f, .statusEffect = NONE,  .stateChangeChance = 0.0f},
									{.name = "Bulk Up",	    .moveType = -1,   .power = 0,  .priority = 0, .accuracy = -1.0f, .type = FIGHTING, .levelRequirement = 7, .selfStateChange = {0,1,1,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,0,0,0,0}, .statusEffectChance = 0.0f, .statusEffect = NONE,  .stateChangeChance = 1.0f},
									{.name = "Sand Attack",	.moveType = -1,   .power = 0, .priority = 0, .accuracy = 1.0f, .type = GROUND,    .levelRequirement = 22, .selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,0,0,-1,0}, .statusEffectChance = 0.0f, .statusEffect = NONE,.stateChangeChance = 1.0f},
									{.name = "Aerial Ace",  .moveType = 1,    .power = 60,  .priority = 0, .accuracy = -1.0f, .type = FLYING,   .levelRequirement = 24,.selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,0,0,0,0}, .statusEffectChance = 0.0f, .statusEffect = NONE,.stateChangeChance = 0.0f} };

	int EVYield[] = { 0,0,0,0,0,2 };

	self->pokemonStats.evolveLevel = 36;
	self->pokemonStats.evolveTo = "monster_gladiator";
