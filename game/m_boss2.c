...
void SP_monster_boss2 (edict_t *self)
{
	...
	self->pokemonStats.type[0] = FLYING;
	self->pokemonStats.type[1] = ICE;

	// 500 stat total
	self->pokemonStats.baseStats[0] = 80;
	self->pokemonStats.baseStats[1] = 30;
	self->pokemonStats.baseStats[2] = 65;
	self->pokemonStats.baseStats[3] = 110;
	self->pokemonStats.baseStats[4] = 75;
	self->pokemonStats.baseStats[5] = 140;
	...
	pokemonMove learnableMoves[] = { {.name = "Quick Attack",.moveType = 1,   .power = 40, .priority = 1, .accuracy = 1.0f, .type = NORMAL,  .levelRequirement = 1, .selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,0,0,0,0}, .statusEffectChance = 0.0f, .statusEffect = NONE,  .stateChangeChance = 0.0f},
									{.name = "Gust",		.moveType = 3,   .power = 40, .priority = 0, .accuracy = 1.0f, .type = FLYING,    .levelRequirement = 3, .selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,0,0,0,0}, .statusEffectChance = 0.0f, .statusEffect = NONE,.stateChangeChance = 0.0f},
									...
									{.name = "Aerial Ace",	.moveType = 1,   .power = 60,  .priority = 0, .accuracy = -1.0f, .type = FLYING,  .levelRequirement = 7, .selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,0,0,0,0},.statusEffectChance = 0.0f, .statusEffect = NONE,  .stateChangeChance = 0.0f},
									{.name = "Swift",		.moveType = 3,  .power = 60,  .priority = 0, .accuracy = -1.0f, .type = NORMAL,    .levelRequirement = 9,.selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,0,0,0,0}, .statusEffectChance = 0.0f, .statusEffect = NONE,.stateChangeChance = 0.0f},

									{.name = "Feather Dance",.moveType = -1,   .power = 0, .priority = 0, .accuracy = 1.0f, .type = FLYING,  .levelRequirement = 17, .selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,-2,0,0,0,0,0,0}, .statusEffectChance = 0.0f, .statusEffect = NONE,  .stateChangeChance = 1.0f},
									{.name = "Twister",		.moveType = 3,   .power = 40, .priority = 0, .accuracy = 1.0f, .type = DRAGON,    .levelRequirement = 19, .selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,0,0,0,0}, .statusEffectChance = 0.0f, .statusEffect = NONE,.stateChangeChance = 0.0f},
									{.name = "Sand Attack",	.moveType = -1,   .power = 0,  .priority = 0, .accuracy = 1.0f, .type = GROUND, .levelRequirement = 21, .selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,0,0,-1,0}, .statusEffectChance = 0.0f, .statusEffect = NONE,  .stateChangeChance = 1.0f},
									{.name = "Acrobatics",	.moveType = 1,   .power = 110,  .priority = 0, .accuracy = 1.0f, .type = FLYING,  .levelRequirement = 23, .selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,0,0,0,0},.statusEffectChance = 0.0f, .statusEffect = NONE,  .stateChangeChance = 0.0f},
									{.name = "Powder Snow", .moveType = 3,  .power = 40,  .priority = 0, .accuracy = 1.0f, .type = ICE,    .levelRequirement = 25,	.selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,0,0,0,0}, .statusEffectChance = 0.1f, .statusEffect = FROZEN, .stateChangeChance = 0.0f},
	
									{.name = "Ice Beam",	.moveType = 3,   .power = 90, .priority = 0, .accuracy = 1.0f, .type = ICE,  .levelRequirement = 37, .selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,0,0,0,0}, .statusEffectChance = 0.1f, .statusEffect = FROZEN,   .stateChangeChance = 0.0f},
									{.name = "Blizzard",	.moveType = 3,  .power = 110,  .priority = 0, .accuracy = .7f, .type = ICE,    .levelRequirement = 39,	.selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,0,0,0,0}, .statusEffectChance = 0.1f, .statusEffect = FROZEN,  .stateChangeChance = 0.0f},
									{.name = "Hurricane", .moveType = 3,  .power = 110,  .priority = 0, .accuracy = .7f, .type = FLYING,    .levelRequirement = 41,	.selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,0,0,0,0}, .statusEffectChance = 0.0f, .statusEffect = NONE, .stateChangeChance = 0.0f},
									{.name = "Glaciate",	.moveType = 3,   .power = 65,  .priority = 0, .accuracy = .95f, .type = ICE,  .levelRequirement = 43, .selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,0,-1,0,0}, .statusEffectChance = 0.0f, .statusEffect = NONE,  .stateChangeChance = 1.0f},
									{.name = "Aeroblast",   .moveType = 3,  .power = 100,  .priority = 0, .accuracy = .95f, .type = FLYING,    .levelRequirement = 45,	.selfStateChange = {0,0,0,0,0,0,0,0},  .enemyStateChange = {0,0,0,0,0,0,0,0}, .statusEffectChance = 0.0f, .statusEffect = NONE, .stateChangeChance = 0.0f} };

	int EVYield[] = { 0,0,0,3,0,0 };
